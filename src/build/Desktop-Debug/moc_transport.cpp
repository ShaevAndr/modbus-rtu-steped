...
QT_MOC_LITERAL(5, 43, 3) // "err"
    ...
    "Transport\0dataReceived\0\0data\0errorOccurred\0"
    "err"
};
...
void Transport::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (Transport::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Transport::dataReceived)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Transport::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Transport::errorOccurred)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void Transport::dataReceived(const QByteArray & _t1)
{
...
// SIGNAL 1
void Transport::errorOccurred(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
